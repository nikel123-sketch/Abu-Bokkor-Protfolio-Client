...
const projectsData = [
  ...
  {
    name: "Foods (client project) ",
    description:
      "A modern and responsive food restaurant website built with React and Tailwind CSS.",
    tech: [
      "HTML",
      "Tailwind CSS",
      "JavaScript",
    ...
    // GitHup: "https://github.com/nikel123-sketch",
    // livLink: "https://zap-shift-project-server.web.app",
    image: "https://i.ibb.co.com/yFBrz6K7/food.webp",
  },
  {
    name: "School Management (Clien Project)",
    description:
      "A modern and user-friendly School Management System for managing students, teachers, and classes efficiently.",
    tech: [
      "HTML",
      "Tailwind CSS",
      "JavaScript",
    ...
    // GitHup: "https://github.com/nikel123-sketch",
    // livLink: "https://zap-shift-project-server.web.app",
    image: "https://i.ibb.co.com/1txgwy0J/school.jpg",
  },
  {
    name: "Bank Management (Client project)",
    description:
      "A secure and efficient Bank Management System for handling accounts, transactions, and customer data.",
    tech: [
      "HTML",
      "Tailwind CSS",
      "JavaScript",
    ...
    // GitHup: "https://github.com/nikel123-sketch",
    // livLink: "https://zap-shift-project-server.web.app",
    image: "https://i.ibb.co.com/KpTj7N3m/Bank.jpg",
  },
  {
    name: "Md Nowshad (nikel) (Client project)",
    description:
      "Full-stack courier management system featuring role-based dashboards, real-time order tracking, and secure authentication.",
    tech: [
      "HTML",
    ...
    // GitHup: "https://github.com/nikel123-sketch",
    // livLink: "https://zap-shift-project-server.web.app",
    image: "https://i.ibb.co.com/1f4Skv9q/nikelbanner.png",
  },
];
